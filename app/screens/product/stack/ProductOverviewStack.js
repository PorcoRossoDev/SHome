...
const ProductOverviewStack = () => {
  ...
  return (
    <View className='flex-1 bg-white'>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('ProductAddStack')} className='absolute bottom-4 right-4 w-16 h-16 bg-blue-600 justify-center items-center rounded-full border-2 border-gray-400'>
