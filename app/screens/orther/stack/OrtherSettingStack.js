                    ...
                    >
                        <TouchableOpacity onPress={() => navigation.navigate('SettingStoreStack')} className='flex-row justify-between items-center mb-4 pb-4 pt-4 border-b border-gray-100'>
                            <View className='flex-row items-center'>
                                <View><BuildingStorefrontIcon size={22} color={'#2563eb'} /></View>
                        ...
                        <TouchableOpacity
                            ...
                            <View className='flex-row items-center'>
                                <View><UserGroupIcon size={22} color={'#2563eb'} /></View>
                        ...
                        <TouchableOpacity
                            ...
                            className='flex-row justify-between items-center mb-4 pb-4 border-b border-gray-100'>
                            <View className='flex-row items-center'>
                                <View><CreditCardIcon size={22} color={'#2563eb'} /></View>
                        ...
                        <TouchableOpacity
                            ...
                            className='flex-row justify-between items-center mb-4 pb-4 border-b border-gray-100'>
                            <View className='flex-row items-center'>
                                <View><CircleStackIcon size={22} color={'#2563eb'} /></View>
                        ...
                        <TouchableOpacity
                            ...
                            <View className='flex-row items-center'>
                                <View><BuildingOfficeIcon size={22} color={'#2563eb'} /></View>
                ...
                <TouchableOpacity
                    ...
                    >
                        <View className='flex-row justify-between items-center pb-4 pt-4'>
                            <View className='flex-row items-center'>
                                <View><TagIcon size={22} color={'#2563eb'} /></View>
