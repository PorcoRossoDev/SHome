        ...
        >
          <View
            ...
            <View className='flex-row justify-between mt-1'>
              <View>
                <Text className='text-gray-500 font-sfregular text-f15 mt-1.5'>Thu đơn hàng</Text>
              ...
              <View>
                ...
                <Text className='font-sfmedium text-center text-f14 mt-1.5'>450.000</Text>
              </View>
              <View>
                <Text className='text-gray-500 font-sfregular text-f15 text-right'>Tổng thu</Text>
                <Text className='font-sfmedium text-center text-f14 text-green-600 mt-1.5'>1.400.000</Text>
              </View>
            </View>
          </View>
        </View>
