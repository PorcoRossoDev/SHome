...
import BottomUserFilterSheet from '../user/BottomUserFilterSheet';

const HeaderUser = ({ title, navigation, route, onToggleLayout, layoutOrderPendding = false }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View className='flex-row items-center'>
          <TouchableOpacity 
            ...
            onPress={()=> navigation.navigate('User', {screen: 'RoleListStack'})}>
            <HeroOutline.UserGroupIcon size={19} color={'#333'} />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <BottomUserFilterSheet ref={bottomSheetRef} onClose={closeSheet} />
